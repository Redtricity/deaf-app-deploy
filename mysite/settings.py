...
SECRET_KEY = 'django-insecure-oai^lj%31m0w^z5+h_%o-4sqb=kb_44)s6c0z6w=zs7c4t3%ta'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = [
    'deaf-app-deploy.onrender.com',
    'deaf-app-deploy-production.up.railway.app',  
    'deaf-app-deploy-production-c70d.up.railway.app',  
]

CSRF_TRUSTED_ORIGINS = [
    'https://deaf-app-deploy.onrender.com',
...
INSTALLED_APPS = [
    ...
    'mysite.apps.MysiteConfig',  # mysite app
    'crispy_forms',
    'crispy_bootstrap4',
